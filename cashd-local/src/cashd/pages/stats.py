...
class StatisticsSection(BaseSection):
    ...
    def __init__(self, app: App):
        ...
        style.set_col_alignments(self.transaction_history_table.data_widget, ["l", "l", "r"])
        ...
        style.set_col_alignments(self.inactive_customers_table.data_widget, ["l", "l", "r"])
        ...
        most recent first.
        """
        style.set_col_alignments(self.transac_balance_table.data_widget, ["l", "r", "r", "r"])
        ...
        """
        style.set_col_alignments(self.aggregated_amount_table.data_widget, ["l", "r", "r", "r"])
