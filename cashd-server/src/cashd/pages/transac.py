...
<|{SELECTED_CUSTOMER}|selector|lov={NOMES_USUARIOS}|propagate|height=300px|width=450px|adapter={lambda x: getattr(x, "Value", x)}|on_change={chg_selected_customer}|class_name=sel-user user-selector|>
